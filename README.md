...
- **Project export / import** — share a full project config as a `.slugger.json` file; missing paths flagged on import
- **JWT licensing** — Ed25519 asymmetric; free tier always available; pro tier upgrades without restart
